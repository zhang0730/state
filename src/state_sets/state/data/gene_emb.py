...
def resolve_genes(ensemble_id, return_type="dna", email="rajesh.ilango@arcinstitute.org"):
    Entrez.email = email
...
def parse_genome_for_gene_seq_map(species, fasta_file, output_file=None, return_type="dna"):
