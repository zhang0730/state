...
class Preprocessor:
    def __init__(self, species, source, dest, summary_file, emb_file, emb_idx_file, emb_offset=0) -> None:
    ...
    def _convert_to_csr(self, h5f, attrs):
        ...
        csc_matrix = sp.csc_matrix((data, indices, indptr), shape=(num_cells, num_genes))
