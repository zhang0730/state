...
```bash
state-sets sets infer --output /home/dhruvgautam/state-sets/test/ --model_dir /path/to/model/ --checkpoint /path/to/model/checkpoints/last.ckpt --adata /path/to/anndata/processed.h5 --pert_col gene --embed_key X_hvg
```
