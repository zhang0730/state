...
class PerturbationTracker:
    ...
    def track_celltype_perturbations(
        self,
        h5_file: h5py.File,
        dataset_name: str,
        cell_type: str,
    ...
    def get_dataset_perturbations(self, dataset: str) -> Set[str]:
        ...
        return set().union(*(perts for cell_type, perts in self.perturbations[dataset].items()))
    ...
    def compute_shared_perturbations(self, eval_dataset: str) -> Set[str]:
        ...
        other_perts = set().union(*(self.get_dataset_perturbations(d) for d in other_datasets))
